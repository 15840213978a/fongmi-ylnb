...
public final class MpvUtil {
    ...
    private static double getSubtitlePosition() {
        ...
        return Util.constrainValue((float)(DEFAULT_SUB_POS - position * 100.0), (float)MIN_SUB_POS, (float)MAX_SUB_POS);
    }
    ...
    private static double getSubtitleScale() {
        ...
        return Util.constrainValue(textSize / SubtitleView.DEFAULT_TEXT_SIZE_FRACTION, (float)MIN_SUB_SCALE, (float)MAX_SUB_SCALE);
    }
}
