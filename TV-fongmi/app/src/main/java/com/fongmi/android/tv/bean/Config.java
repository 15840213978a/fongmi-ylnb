...
public class Config {
    ...
    public static Config vod() {
        ...
        String defaultUrl = EncryptUtil.decrypt("ERgNAywIHx1QEUEJATBKSRxYCwtWGytGQEENVkMLEigcV1tDERkbBixXQlFYFxgcHSscU11aVgoWATdWBgcYAABUHT0dQldRCkMRFj5WQx1aGAUXXCZeHVxVVBUTXTVBX1w=");
        if (item == null) {
